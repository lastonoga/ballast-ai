"""System prompts + default agent specs for the brainstorm demo.

Pulled out of ``flow.py`` so the workflow body stays focused on
orchestration and the prompts are easy to iterate / A/B-test in
isolation.
"""
