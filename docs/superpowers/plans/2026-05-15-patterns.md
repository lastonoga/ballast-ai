...
```
src/pydantic_ai_stateflow/patterns/
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/errors.py`
- Create: `src/pydantic_ai_stateflow/patterns/loop_recovery.py`
- Modify: `src/pydantic_ai_stateflow/patterns/__init__.py`
...
`src/pydantic_ai_stateflow/patterns/errors.py`:
...
`src/pydantic_ai_stateflow/patterns/loop_recovery.py`:
...
Update `src/pydantic_ai_stateflow/patterns/__init__.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/errors.py src/pydantic_ai_stateflow/patterns/loop_recovery.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/__init__.py tests/patterns/test_errors.py tests/patterns/test_loop_recovery.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/reflection.py`
- Modify: `src/pydantic_ai_stateflow/patterns/__init__.py`
...
async def test_reflection_invokes_loop_recovery_on_repeated_drafts():
    ...
    from pydantic_ai_stateflow.capabilities.helpers import TypedLoopGuard
...
`src/pydantic_ai_stateflow/patterns/reflection.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/reflection.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/test_reflection.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/mapreduce/__init__.py`
- Create: `src/pydantic_ai_stateflow/patterns/mapreduce/primitives.py`
...
`src/pydantic_ai_stateflow/patterns/mapreduce/__init__.py`:
...
`src/pydantic_ai_stateflow/patterns/mapreduce/primitives.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/mapreduce/__init__.py src/pydantic_ai_stateflow/patterns/mapreduce/primitives.py tests/patterns/mapreduce/__init__.py tests/patterns/mapreduce/test_primitives.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/mapreduce/pattern.py`
- Modify: `src/pydantic_ai_stateflow/patterns/mapreduce/__init__.py`
- Modify: `src/pydantic_ai_stateflow/patterns/__init__.py`
...
`src/pydantic_ai_stateflow/patterns/mapreduce/pattern.py`:
...
```python
from pydantic_ai_stateflow.patterns.mapreduce.pattern import MapReduce
from pydantic_ai_stateflow.patterns.mapreduce.primitives import Chunker, Reducer
...
```bash
git add src/pydantic_ai_stateflow/patterns/mapreduce/pattern.py src/pydantic_ai_stateflow/patterns/mapreduce/__init__.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/mapreduce/test_mapreduce.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/hitl/__init__.py`
- Create: `src/pydantic_ai_stateflow/patterns/hitl/prompt.py`
- Create: `src/pydantic_ai_stateflow/patterns/hitl/response.py`
- Create: `src/pydantic_ai_stateflow/patterns/hitl/channel.py`
- Create: `src/pydantic_ai_stateflow/patterns/hitl/policy.py`
...
`src/pydantic_ai_stateflow/patterns/hitl/prompt.py`:
...
`src/pydantic_ai_stateflow/patterns/hitl/response.py`:
...
`src/pydantic_ai_stateflow/patterns/hitl/channel.py`:
...
`src/pydantic_ai_stateflow/patterns/hitl/policy.py`:
...
`src/pydantic_ai_stateflow/patterns/hitl/__init__.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/hitl tests/patterns/hitl
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/hitl/gate.py`
...
`src/pydantic_ai_stateflow/patterns/hitl/gate.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/hitl/gate.py src/pydantic_ai_stateflow/patterns/hitl/__init__.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/hitl/test_gate.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/mutation/__init__.py`
- Create: `src/pydantic_ai_stateflow/patterns/mutation/primitives.py`
- Create: `src/pydantic_ai_stateflow/patterns/mutation/reject_policy.py`
...
`src/pydantic_ai_stateflow/patterns/mutation/primitives.py`:
...
`src/pydantic_ai_stateflow/patterns/mutation/reject_policy.py`:
...
`src/pydantic_ai_stateflow/patterns/mutation/__init__.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/mutation/__init__.py src/pydantic_ai_stateflow/patterns/mutation/primitives.py src/pydantic_ai_stateflow/patterns/mutation/reject_policy.py tests/patterns/mutation/__init__.py tests/patterns/mutation/test_primitives.py tests/patterns/mutation/test_reject_policy.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/mutation/pipeline.py`
- Modify: `src/pydantic_ai_stateflow/patterns/mutation/__init__.py`
- Modify: `src/pydantic_ai_stateflow/patterns/__init__.py`
...
`src/pydantic_ai_stateflow/patterns/mutation/pipeline.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/mutation/pipeline.py src/pydantic_ai_stateflow/patterns/mutation/__init__.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/mutation/test_pipeline.py
...
**Files:**
- Create: `src/pydantic_ai_stateflow/patterns/mutation/stages.py`
- Modify: `src/pydantic_ai_stateflow/patterns/mutation/__init__.py`
- Modify: `src/pydantic_ai_stateflow/patterns/__init__.py`
...
`src/pydantic_ai_stateflow/patterns/mutation/stages.py`:
...
```bash
git add src/pydantic_ai_stateflow/patterns/mutation/stages.py src/pydantic_ai_stateflow/patterns/mutation/__init__.py src/pydantic_ai_stateflow/patterns/__init__.py tests/patterns/mutation/test_stages.py
...
Add to `src/pydantic_ai_stateflow/__init__.py`:
...
```bash
git add src/pydantic_ai_stateflow/__init__.py tests/patterns/test_public_api.py
...
- `from pydantic_ai_stateflow import Reflection, MapReduce, MutationPipeline, HITLGate, ApprovalStage, PartialApprovalStage, Pattern, ...` works
...
- /Users/kirunya/conductor/workspaces/pydantic-ai-stateflow-engine/philadelphia-v1/src/pydantic_ai_stateflow/patterns/protocol.py
- /Users/kirunya/conductor/workspaces/pydantic-ai-stateflow-engine/philadelphia-v1/src/pydantic_ai_stateflow/capabilities/helpers/typed_loop_guard.py
- /Users/kirunya/conductor/workspaces/pydantic-ai-stateflow-engine/philadelphia-v1/src/pydantic_ai_stateflow/capabilities/helpers/as_critique.py
- /Users/kirunya/conductor/workspaces/pydantic-ai-stateflow-engine/philadelphia-v1/src/pydantic_ai_stateflow/persistence/__init__.py
